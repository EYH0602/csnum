...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.49\textwidth}
	    \centering
	    \includegraphics[width=\textwidth]{img/report1_cell_2_output_0.png}
	...
	\begin{subfigure}[b]{0.49\textwidth}
	    \centering
	     \includegraphics[width=\textwidth]{img/report1_cell_6_output_0.png}
	     \caption{$f_2(x) = 5^{-x} - 2$}
	     \label{fig:1}
	\end{subfigure}
...
\begin{figure}[H]
    \centering
     \includegraphics[width=0.8\textwidth]{img/report1_cell_5_output_1.png}
...
\begin{figure}[H]
    \centering
     \includegraphics[width=0.8\textwidth]{img/report1_cell_8_output_1.png}
